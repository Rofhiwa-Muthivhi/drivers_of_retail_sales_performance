...
-- Purpose:
-- To assess the quality of the datasets before performing data cleaning and business analysis.
-- =========================================================================================================================

-- =========================================================================================================================
-- The following assessments will be performed:
-- 1) Missing Values
-- 2) Table Relationship Validation
-- 3) Negative Weekly Sales
-- 4) Store Size Validation
-- 5) Temperature Range Validation
-- 6) Fuel Price Validation
-- 7) Consumer Price Index (CPI) Validation
...
-- This section was completed in the
-- "02_exploratory_data_analysis/03_missing_values" section. 
-- =========================================================================================================================
...
-- Purpose:
-- To identify unrealistic temperature values, ensuring that weather data used for analysis is 
-- valid and reliable.
-- =========================================================================================================================
...
SELECT 
       MIN(TRY_CAST(temperature AS FLOAT)) AS minimum_temperature,
...
-- Purpose:
-- To identify unrealistic fuel price values, ensuring that fuel price data used for analysis is 
-- valid and reliable.
-- =========================================================================================================================
...
SELECT 
       MIN(TRY_CAST(fuel_price AS DECIMAL(10,2))) AS minimum_fuel_price,
...
SELECT 
       MIN(TRY_CAST(cpi AS FLOAT)) AS minimum_cpi,
...
SELECT 
       MIN(TRY_CAST(unemployment AS FLOAT)) AS minimum_unemployment,
       MAX(TRY_CAST(unemployment AS FLOAT)) AS maximum_unemployment
FROM [retail_analysis].[dbo].[features];


-- Check for unrealistic unemployment values.
-- Valid unemployment rates should fall between 0% and 100%.
SELECT store,
       [date],
       Unemployment
FROM [retail_analysis].[dbo].[features]
...
-- Purpose:
-- To verify that the IsHoliday column contains only valid holiday flag values,
-- ensuring the data is suitable for conversion during the data cleaning phase.
-- =========================================================================================================================

-- Review the distinct values stored in the IsHoliday column in both the Sales and Seatures tables.
